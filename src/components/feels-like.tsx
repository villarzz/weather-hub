...
export default function FeelsLike() {
    ...
    if (loading || !weatherData) {
        return (<div className="h-[209px] rounded-xl bg-sky-900/50 p-5 flex animate-pulse" />)
    }
        ...
        <div className="h-[209px] rounded-xl bg-sky-900/50 p-5 flex flex-col items-start space-x-4">
            ...
            <div className="flex items-center justify-center w-full h-full">
                <div className="flex flex-col text-center">
                    <div className="flex">
                        <p className="text-7xl font-semibold text-zinc-100 leading-none">{Math.floor(weatherData.current.feelslike_c)}</p>
